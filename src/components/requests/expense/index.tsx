            ...
            <Table
                ...
                rowComponent={(transaction, index, length) => {
                    ...
                    return (
                        <tr
                            onClick={() => {
                                router.push("/requests/" + expenseRequestId + "/expense-requests" );
                            }}
                            className={cn("text-sm cursor-pointer border-[#5A5A5A99]", {
                                "border-b": index !== length - 1,
                            })}>
                            <td className='p-4 text-black-500 whitespace-nowrap'>{expenseRequestId}</td>
